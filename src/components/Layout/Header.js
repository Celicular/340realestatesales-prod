                    ...
                    <div className="pl-3 space-y-2">
                      {link.children.map((child) =>
                        child.children ? (
                          ...
                          <div key={child.name} className="mb-3">
                            ...
                            <div className="pl-4 space-y-1 mt-1">
                              {child.children.map((grandChild) =>
                                grandChild.disabled || !grandChild.path ? (
                                  <span
                                    key={grandChild.name}
                                    className="block px-4 py-2 rounded-xl text-sm font-barlow text-gray-400 cursor-not-allowed"
                                  >
                                    {grandChild.name}
                                  </span>
                          ...
                          <span
                            key={child.name}
                            className="block px-4 py-2 rounded-xl text-base font-barlow text-gray-400 cursor-not-allowed"
                          >
                            {child.name}
                          </span>

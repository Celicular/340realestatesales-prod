            ...
            <div className="grid grid-cols-4 h-full items-center">
              ...
              <div className="col-span-2 col-start-1">
                ...
                <div className="bg-white/95 backdrop-blur-sm p-8 xl:p-12 rounded-none shadow-2xl">
                  {/* Main Heading */}
                  <h2 className="text-4xl xl:text-5xl font-serif font-bold text-black tracking-wider mb-6 xl:mb-8 uppercase leading-tight">
                    AREAS OF EXPERTISE
                  </h2>
                  
                  {/* Sub-heading */}
                  <p className="text-lg xl:text-xl text-black font-serif uppercase tracking-wider mb-4 xl:mb-6 leading-relaxed">
                    BROWSE VARIOUS PARTS OF ST JOHN AND THE SURROUNDING ISLANDS
                  </p>
                  
                  {/* Description */}
                  <p className="text-base xl:text-lg font-serif text-gray-700 leading-relaxed mb-8 xl:mb-10">
                    These neighborhoods have plenty of beautiful properties to offer. Browse through available listings in the community.
                  </p>
                  
                  {/* Call-to-Action Button */}
                  <div className="text-center">
                    <button className="bg-gray-800 text-white font-serif font-semibold px-8 xl:px-10 py-3 xl:py-4 rounded-lg hover:bg-gray-700 transition-colors duration-300 text-base xl:text-lg tracking-wide uppercase">
                      LEARN MORE
                    </button>
                  </div>
                </div>

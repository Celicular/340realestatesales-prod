        ...
        if (result.success) {
          ...
          if (result.data.length > 0) {
            ...
            console.log(
              "  - soldPrice:",
              firstProp.soldPrice,
              typeof firstProp.soldPrice
            );
            console.log(
              "  - listingPrice:",
              firstProp.listingPrice,
              typeof firstProp.listingPrice
            );
            console.log(
              "  - askPrice:",
              firstProp.askPrice,
              typeof firstProp.askPrice
            );
            console.log(
              "  - askingPrice:",
              firstProp.askingPrice,
              typeof firstProp.askingPrice
            );
            console.log(
              "  - listPrice:",
              firstProp.listPrice,
              typeof firstProp.listPrice
            );
          }
      ...
      <div className="relative mt-8 max-w-7xl mx-auto px-4 sm:px-8">
        ...
        {filteredProperties.length > 2 && (
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-16 p-3 text-white transition-all duration-300 rounded-full shadow-lg bg-[#d4b196] hover:opacity-80 hover:scale-110 z-10"
        ...
        {filteredProperties.length > 2 && (
          <button
            onClick={goToNext}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-16 p-3 text-white transition-all duration-300 rounded-full shadow-lg bg-[#d4b196] hover:opacity-80 hover:scale-110 z-10"
